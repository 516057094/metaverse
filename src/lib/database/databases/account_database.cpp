...
namespace libbitcoin {
	namespace database {
		...
		account_database::account_database(const path& lookup_filename,
		...
		void account_database::add_output(const short_hash& key,
		...
		void account_database::add_input(const short_hash& key,
		...
		void account_database::delete_last_row(const short_hash& key)
		{
			rows_multimap_.delete_last_row(key);
		}
		/*
		account_compact::list account_database::get(const short_hash& key,
		...
		*/
		void account_database::sync()
		{
			lookup_manager_.sync();
			rows_manager_.sync();
		}

		account_statinfo account_database::statinfo() const
		{
			return
			{
				lookup_header_.size(),
