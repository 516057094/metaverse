...
struct BCD_API account_statinfo
{
...
/// which returns several rows giving the account for that address.
class BCD_API account_database
{
public:
    /// Construct the database.
	account_database(const boost::filesystem::path& lookup_filename,
    ...
    chain::account_compact::list get(const short_hash& key, size_t limit,
...
*/
	...
	account_statinfo statinfo() const;
