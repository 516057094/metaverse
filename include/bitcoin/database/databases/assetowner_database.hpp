 ...
 */
#ifndef LIBBITCOIN_DATABASE_ASSETOWNER_DATABASE_HPP
#define LIBBITCOIN_DATABASE_ASSETOWNER_DATABASE_HPP
...
struct BCD_API assetowner_statinfo
{
...
/// which returns several rows giving the assetowner for that address.
class BCD_API assetowner_database
{
public:
    /// Construct the database.
	assetowner_database(const boost::filesystem::path& lookup_filename,
    ...
    /// Initialize a new assetowner database.
    bool create();
    ...
    chain::assetowner_compact::list get(const short_hash& key, size_t limit,
...
*/
	...
	assetowner_statinfo statinfo() const;
